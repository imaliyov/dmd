...
def test_dmd():
    ...
    np.testing.assert_allclose(dmd_run.mode_array[:, :10], mode_array_10_desired, atol=1e-10)
    np.testing.assert_allclose(dmd_run.omega_array, omega_array_desired, atol=1e-10)
    np.testing.assert_allclose(dmd_run.mode_ampl_array, mode_ampl_array_desired, atol=1e-10)
